  ...
  return (
    <div>
      <button
        id="wallet"
        type="button"
        className="px-16 py-2 relative text-md font-medium items-center overflow-hidden justify-end bg-black rounded-2xl text-white bg-gradient-to-br from-black to-blue-500 group-hover:from-blue-600 hover:to-blue-700"
      >
        {" "}
        <svg
